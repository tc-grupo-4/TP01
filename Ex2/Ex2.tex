...
\begin{figure}[h]
\begin{centering}
\includegraphics[scale=0.4]{scope_0}
\par\end{centering}
\caption{Resultados}
\label{2_1}
\end{figure}
...
\begin{figure}[h]
\begin{centering}
\includegraphics[scale=0.65]{MedyPost}
\par\end{centering}
...
\begin{figure}[h]
\begin{centering}
\includegraphics[scale=0.4]{300k}
\par\end{centering}
