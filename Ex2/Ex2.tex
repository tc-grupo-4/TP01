...
\begin{figure}[h]
\begin{centering}
\includegraphics[scale=0.25]{scope_0}
\par\end{centering}
\begin{centering}
\includegraphics[scale=0.3]{Med_Mod}\includegraphics[scale=0.3]{Med_Ph}
\par\end{centering}
\caption{Resultados}
\label{2_1}
\end{figure}
...
\begin{figure}[h]
\begin{centering}
\includegraphics[scale=0.35]{Square}\includegraphics[scale=0.35]{DiagEspcTeo}
\par\end{centering}
...
\begin{figure}[h]
\begin{centering}
\includegraphics[scale=0.4]{Med_Arm}
\par\end{centering}
...
$f_{a}\ggg63(kHz)$, nuestro circuito se comportará como un integrador.

En particular, si tenemos una frecuencia $f_{i}=640(kHz)$, $2\pi f_{a}RC\gg1$,con
...
\begin{figure}[h]
\begin{centering}
\includegraphics[scale=0.3]{Med_640}
\par\end{centering}
\caption{Circuito como integrador a 640 (kHz)}
\label{2_6}
