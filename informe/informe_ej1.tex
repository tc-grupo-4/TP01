...
\begin{figure}[H]                                                       
    \centering\includegraphics[width=0.5\textwidth]{resources/circuitoconkenelly.png}
...
\begin{figure}[H]                                                       
    \centering\includegraphics[width=0.8\textwidth]{resources/circuitoconkenellysimplificado.png}
...
\begin{figure}[H] 
\begin{center}
\makebox[\textwidth]{\includegraphics[width=\paperwidth, height=\textheight,keepaspectratio]{resources/bode_ltspice_teorico.png}}
\caption{Circuito con los componentes definidos}
\label{fig:bode_ltspice_teorico}
\end{center}
\end{figure}
...
\begin{figure}[H] 
\begin{center}
\makebox[\textwidth]{\includegraphics[width=\paperwidth, height=\textheight,keepaspectratio]{resources/respuestaimpulsiva.png}}
...
\begin{figure}[H] 
\begin{center}
\makebox[\textwidth]{\includegraphics[width=\paperwidth, height=\textheight,keepaspectratio]{resources/Superpuesto.pdf}}
\caption{Filtro Notch Pasivo}
...
\begin{figure}[H] 
\begin{center}
\makebox[\textwidth]{\includegraphics[width=\paperwidth, height=\textheight,keepaspectratio]{resources/respuestaalescalon.png}}
