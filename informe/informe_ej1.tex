...
\begin{figure}[H]                                                       
    \centering\includegraphics[width=0.8\textwidth]{resources/circuitoconKennellysimplificado.png}
...
\begin{figure}[H] 
\begin{center}
\makebox[\textwidth]{\includegraphics[width=\paperwidth, height=\textheight,keepaspectratio]{resources/bode_ltspice_teorico2.png}}
\caption{Circuito con los componentes definidos}
\label{fig:bode_ltspice_teorico}
\end{center}
\end{figure}
